...
const aeroflyConfigFile = function(filename) {
  ...
  _public.setFromAeroflyObject = function(aeroflyValues) {
    ...
    configFileContent = _private.setGroup(configFileContent, 'tmsettings_wind', 2, (all) => {
      all = _private.setValue(all, 'strength', aeroflyValues.wind_strength);
      all = _private.setValue(all, 'direction_in_degree', aeroflyValues.wind_direction_in_degree);
      all = _private.setValue(all, 'turbulence', aeroflyValues.wind_turbulence);
      all = _private.setValue(all, 'thermal_activity', aeroflyValues.wind_thermal_activity);
      return all;
    });
