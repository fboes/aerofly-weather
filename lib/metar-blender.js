...
const metarBlender = function(fromMetar, toMetar) {
  ...
  if(!fromMetar.ceiling) {
    fromMetar.ceiling = { code: 'CLR', feet_agl: 30000, meters_agl: 1000 };
  }
  if(!toMetar.ceiling) {
    toMetar.ceiling = { code: 'CLR', feet_agl: 30000, meters_agl: 1000 };
  }
   ...
   * @return {Object} blended value
   */
  _private.blendCeiling = function(from, to, percentage) {
    return {
      code: percentage < 0.5 ? from.code : to.code,
      feet_agl: _private.blendValue(from.feet_agl, to.feet_agl, percentage),
      meters_agl: _private.blendValue(from.meters_agl, to.meters_agl, percentage)
    };
  };
  ...
  _public.blend = function(percentage) {
    ...
    return {
      ...
      ceiling: _private.blendCeiling(fromMetar.ceiling, toMetar.ceiling, percentage),
      clouds: [
