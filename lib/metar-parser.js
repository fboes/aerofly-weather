      ...
      case 2:
        ...
        if (match) {
          ...
          metarObject.wind = {
            ...
            speed_kts: (match[4] === 'MPS') ? match[2] / 1.9438445 : match[2],
            speed_mph: (match[4] === 'MPS') ? match[2] * 2.236936  : match[2] * 1.15078,
            speed_mps: (match[4] === 'MPS') ? match[2]             : match[2] * 1.9438445,
            gust_kts:  (match[4] === 'MPS') ? match[3] / 1.9438445 : match[3],
            gust_mph:  (match[4] === 'MPS') ? match[3] * 2.236936  : match[3] * 1.15078,
            gust_mps:  (match[4] === 'MPS') ? match[3]             : match[3] * 1.9438445
          };
          mode = 3;
        }
        break;
      case 3:
        ...
        if (match) {
          ...
          metarObject.visibility = {
            miles:  (match[3] && match[3] === 'SM') ? match[1]        : match[1] / 1609,
            meters: (match[3] && match[3] === 'SM') ? match[1] * 1609 : match[1]
          };
      ...
      case 4:
        ...
        if (match) {
          ...
          let cloud = {
            ...
            base_meters_agl: match[2] * 0.3048
          };
      ...
      case 5:
        ...
        if (match) {
          ...
          metarObject.temperature = {
            celsius: match[1],
            fahrenheit: match[1] * 1.8 + 32
          };
          metarObject.dewpoint = {
            celsius: match[2],
            fahrenheit: match[2] * 1.8 + 32
          };
          mode = 6;
        }
        break;
      case 6:
        ...
        if (match) {
          ...
          metarObject.barometer = {
            hg:  (match[1] === 'Q') ? match[2] * 0.029529988 : match[2] / 100,
            kpa: (match[1] === 'Q') ? match[2] / 10          : match[2] / 29.529988,
            mb:  (match[1] === 'Q') ? match[2] / 100         : match[2] / 295.29988
          };
          mode = 7;
        }
        break;
